    ...
    <div className="max-w-4xl mx-auto p-6 animate-fadeIn">
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <a href="/staff/attendanceHistory" className="flex items-center justify-center gap-2 flex-1 px-4 py-3 bg-blue-600 text-white rounded hover:bg-blue-700 transition-all hover:scale-105">
            <CalendarIcon className="h-5 w-5" />
            Attendance
          </a>
          <a href="/staff/profile" className="flex items-center justify-center gap-2 flex-1 px-4 py-3 bg-gray-700 text-white rounded hover:bg-gray-800 transition-all hover:scale-105">
            <UserIcon className="h-5 w-5" />
            Profile
          </a>
          <a href="/staff/settings" className="flex items-center justify-center gap-2 flex-1 px-4 py-3 bg-green-600 text-white rounded hover:bg-green-700 transition-all hover:scale-105">
