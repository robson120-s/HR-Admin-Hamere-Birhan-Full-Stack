...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    const fakeUser = {
      name: "Ethan Mitchell",
      email: "ethanmitchell@example.com",
      photoUrl: "https://ui-avatars.com/api/?name=Ethan+Mitchell&background=0D8ABC&color=fff",
      designation: "UI/UX Design Team",
      position: "Web Designer",
      employeeId: "MD-0001",
      dateOfJoining: "05 01 2024",
      phone: "+1(800) 642 7676",
      birthday: "28 December 1992",
      address: "100 Terminal, Fort Lauderdale, Miami 33315, United States",
      gender: "Male",
      emergencyContacts: {
        primary: { name: "John Doe", relationship: "Father", phone: "9876543210", email: "father@example.com", address: "150, New York" },
        secondary: { name: "Jane Doe", relationship: "Mother", phone: "9876543211", email: "mother@example.com", address: "150, New York" }
      },
      education: [
        { institution: "International College of Arts and Science (UG)", degree: "MSc in Computer Science", period: "2000 - 2003" },
        { institution: "International College of Arts and Science (PG)", degree: "BSc in Computer Science", period: "2000 - 2003" }
      ],
      experience: [
        { company: "Envato Inc, Melbourne", position: "Head Of Review Team", period: "2020 - Present" },
        { company: "CodeCanyon Sydney", position: "Software Developer", period: "2016 - 2018" }
      ],
      bankAccount: { accountHolder: "Ethan Mitchell", accountNumber: "123456789", bankName: "ABC Bank", branch: "Miami Branch", swiftCode: "ABCUS33" },
      passport: { number: "A1234567", nationality: "American", issueDate: "15 March 2020", expiryDate: "15 March 2030", scanCopy: "https://example.com/passport-scan.pdf" },
      socialProfiles: { linkedin: "Ethan Mitchell", twitter: "Ethan Mitchell", facebook: "Ethan Mitchell", instagram: "ethan_mitchell", whatsapp: "+1(800) 642 7676" }
    };
