...
export default function ProfilePage() {
  const user = {
    ...
    fullName: 'Jane Doe',
    baptismalName: 'Mariamawit', // Added baptismal name
    email: 'jane@example.com',
    phone: '+1234567890',
    address: '123 Main St, New York', // Added address
    subcity: 'Manhattan', // Added subcity
    department: 'Engineering',
    role: 'Frontend Developer',
    maritalStatusId: 'Single', // Added marital status
    sex: 'Female', // Added sex
    nationality: 'Ethiopian', // Added nationality
    dateBirth: '1995-04-10', // Added date of birth
    joined: '2023-06-15',
    salary: '$60,000/year',
